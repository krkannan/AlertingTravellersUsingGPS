...
public class ProximityActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent notificationIntent = new Intent(getApplicationContext(),AndroidTextToSpeechActivity.class);
		...
		NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(getApplicationContext())
							...
							.setContentText(DataEntry.addressss)
		...
		startActivity(new Intent(getApplicationContext(), AndroidTextToSpeechActivity.class));
